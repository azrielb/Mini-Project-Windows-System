...
namespace BL_WcfService {
    public class BL_WCF_imp : IBL_WCF<List<Room>, List<Tour_Agency>, List<Reservation>> {
        /// <summary>
        /// singleton
        /// </summary>
        private static BL_WCF_imp singleton = new BL_WCF_imp();
        /// <summary>
        /// singleton. this is internal because the class have to be created by a factory.
        /// </summary>
        internal static BL_WCF_imp Singleton { get { return singleton; } }
        // Fields
